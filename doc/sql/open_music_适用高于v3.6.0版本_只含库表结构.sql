...
-- 导出  表 open_music.account 结构
CREATE TABLE IF NOT EXISTS `account` (
  `username` varchar(128) COLLATE utf8_unicode_ci NOT NULL,
  `password` varchar(256) COLLATE utf8_unicode_ci NOT NULL,
  `two_factor_secret` varchar(256) COLLATE utf8_unicode_ci NOT NULL,
...
CREATE TABLE IF NOT EXISTS `file_part_detail` (
  `id` bigint(20) unsigned NOT NULL AUTO_INCREMENT COMMENT '分片id',
  `platform` varchar(32) COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT '存储平台',
  `upload_id` varchar(128) COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT '上传ID，仅在手动分片上传时使用',
...
CREATE TABLE IF NOT EXISTS `music_tag` (
  `id` bigint(20) unsigned NOT NULL AUTO_INCREMENT COMMENT '音乐表主键',
  `music_id` bigint(20) unsigned NOT NULL DEFAULT '0' COMMENT 'music_info 表id',
  `tag_id` bigint(20) unsigned NOT NULL DEFAULT '0' COMMENT 'tag_info 表id',
  `status` tinyint(1) NOT NULL DEFAULT '0' COMMENT '是否删除，0-已启用，1-已停用，2-已删除',
  `gmt_created` datetime NOT NULL DEFAULT CURRENT_TIMESTAMP COMMENT '创建时间',
  `gmt_modified` datetime NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP COMMENT '更新时间',
  PRIMARY KEY (`id`) USING BTREE,
...
CREATE TABLE IF NOT EXISTS `sys_user` (
  ...
  `gmt_created` datetime NOT NULL DEFAULT CURRENT_TIMESTAMP COMMENT '创建时间',
  `gmt_modified` datetime NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP COMMENT '更新时间',
  `username` varchar(120) CHARACTER SET utf8mb4 NOT NULL COMMENT '用户名',
  `password` varchar(300) CHARACTER SET utf8mb4 NOT NULL COMMENT '密码',
  `two_factor_secret` varchar(300) CHARACTER SET utf8mb4 NOT NULL COMMENT '2fa密钥',
