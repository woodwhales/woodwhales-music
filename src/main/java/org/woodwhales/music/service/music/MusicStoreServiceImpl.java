...
public class MusicStoreServiceImpl implements MusicStoreService {
    ...
    static {
        musicStore = Lists.newArrayList(
                new MusicStoreInfo("仓库01", "https://cdn.jsdelivr.net/gh/woodwhales/woodwhales-music-store/"),
                ...
                new MusicStoreInfo("仓库04", "https://cdn.jsdelivr.net/gh/woodwhales/woodwhales-music-store04@m01/"),
                new MusicStoreInfo("仓库05", "https://cdn.jsdelivr.net/gh/woodwhales/woodwhales-music-store05@001/"),
                new MusicStoreInfo("仓库06", "https://cdn.jsdelivr.net/gh/woodwhales/woodwhales-music-store06@001/")
        );
    }
